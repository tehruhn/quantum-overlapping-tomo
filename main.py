...
from create_ghz_circuits import create_ghz_circuits 
...
quantum_circuit = create_ghz_circuits([[0, 1], [2, 3]])
...
for iter in range(6):
    ...
    calculated_density_matrix += density_matrix[1][iter] * pauli("IX")/4
    calculated_density_matrix += density_matrix[2][iter] * pauli("IY")/4
    calculated_density_matrix += density_matrix[3][iter] * pauli("IZ")/4
    calculated_density_matrix += density_matrix[4][iter] * pauli("XI")/4
    calculated_density_matrix += density_matrix[5][iter] * pauli("YI")/4
    calculated_density_matrix += density_matrix[6][iter] * pauli("ZI")/4
    calculated_density_matrix += density_matrix[7][iter] * pauli("XX")/4
    calculated_density_matrix += density_matrix[8][iter] * pauli("YY")/4
    calculated_density_matrix += density_matrix[9][iter] * pauli("ZZ")/4
    calculated_density_matrix += density_matrix[10][iter] * pauli("XY")/4
    calculated_density_matrix += density_matrix[11][iter] * pauli("YX")/4
    calculated_density_matrix += density_matrix[12][iter] * pauli("XZ")/4
    calculated_density_matrix += density_matrix[13][iter] * pauli("ZX")/4
    calculated_density_matrix += density_matrix[14][iter] * pauli("YZ")/4
    calculated_density_matrix += density_matrix[15][iter] * pauli("ZY")/4
    #calculated_density_matrix = make_density_matrix_physical(calculated_density_matrix)
    print(str(calculated_density_matrix))
    #print("Neg " + str(iter) + ": ", str(n(calculated_density_matrix)))
